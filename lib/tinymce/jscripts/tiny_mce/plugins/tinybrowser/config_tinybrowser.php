...
//require_once('../../../'.SYSTEMPATH.'system.php');
...
$tinybrowser['obfuscate'] = 'fdJsaPNst53rewfZFew';
...
$position = $_SERVER['DOCUMENT_ROOT'].$folder;

$tinybrowser['docroot'] = rtrim($position,'/');
 Finish Added by Fabio */
...
$tinybrowser['path']['image'] = '/easymagazinefiles/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/easymagazinefiles/media/'; // Media files location
$tinybrowser['path']['file']  = '/easymagazinefiles/files/'; // Other files location
