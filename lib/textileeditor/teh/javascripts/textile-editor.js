...
var TEH_PATH = '../../../lib/textileeditor/'; // Path to TEH plugin, include /'s if needed
	...
	prepareButton: function(button) {
	    ...
	    theButton.setAttribute('tagStart', button.tagStart);
   	  ...
   	  theButton.setAttribute('open', button.open);
		  ...
		  img.src = TEH_PATH + 'teh/images/textile-editor/' + button.display;
...
document.write('<script src="' + TEH_PATH + 'teh/javascripts/textile-editor-config.js" type="text/javascript"></script>');