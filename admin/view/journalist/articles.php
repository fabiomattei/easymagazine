                    ...
                    <div class="table">
                        ...
                        <table class="listing" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?PHPif ($ar->isUser($_SESSION['user']->getId())) { ?>
                                    <a href="article.php?action=edit&id=<?PHPecho $ar->getId(); ?>&list=<?PHP echo$lastList?>&pageSelected=<?PHP echo$pageSelected?>"><img src="../../resources/img/edit-icon.gif" width="16" height="16" alt="" /></a>
                                    <?PHP} else { ?>
                                    &nbsp;
                                    <?PHP} ?>
                                </td>
                                ...
                                <td><a href="article.php?action=preview&id=<?PHPecho $ar->getId(); ?>"><img src="../../resources/img/preview_icon.png" width="16" height="16" alt="" /></a></td>
                                <td>
                                ...
                                <td class="last">
                                    <?PHPif ($ar->isUser($_SESSION['user']->getId())) { ?>
                                    <a href="article.php?action=requestdelete&id=<?PHPecho $ar->getId(); ?>&list=<?PHP echo$lastList?>&pageSelected=<?PHP echo$pageSelected?>"><img src="../../resources/img/hr.gif" width="16" height="16" alt="add" /></a>
                                    <?PHP} else { ?>
                                    &nbsp;
                                    <?PHP} ?>
                                </td>
                        ...
                        <form name="form1" enctype="multipart/form-data" method="post" action="article.php?action=save&list=<?PHP echo$lastList?>&pageSelected=<?PHP echo$pageSelected?>">
                            <table class="listing form" cellpadding="0" cellspacing="0">
                                ...
                                <tr class="bg">
                                    ...
                                    <td class="last"><textarea name="MetaDescription" rows="4" cols="60"><?PHPecho $art->getMetaDescription(); ?></textarea></td>
                                </tr>
                                <tr>
                                    <td class="first"><strong>Meta Keyword</strong></td>
                                    <td class="last"><textarea name="MetaKeyword" rows="4" cols="60"><?PHPecho $art->getMetaKeyword(); ?></textarea></td>
                                </tr>
                                <tr>
