                    ...
                    <div class="table">
                        ...
                        <table class="listing" cellpadding="0" cellspacing="0">
                            ...
                            foreach ($comms as $cm) {
                                ?>
                            <tr>
                                <td class="first style1"><?PHP echo $cm->getTitle(); ?></td>
                                <td><a href="comment.php?action=edit&id=<?PHP echo $cm->getId(); ?>"><img src="../../resources/img/edit-icon.gif" width="16" height="16" alt="" /></a></td>
                                <td>
                                        <?PHP if ($cm->getPublished()) { ?>
                                    <img src="../../resources/img/tic.png" width="16" height="16" alt="save" />
                                        <?PHP } else { ?>
                                    <img src="../../resources/img/cross.png" width="16" height="16" alt="save" />
                                    <?PHP } ?></td>
                                <td class="last"><a href="comment.php?action=requestdelete&id=<?PHP echo $cm->getId(); ?>&list=<?PHP echo$lastList?>&pageSelected=<?PHP echo$pageSelected?>"><img src="../../resources/img/hr.gif" width="16" height="16" alt="add" /></a></td>
                            </tr>
                            <?
                            }
                            ?>
