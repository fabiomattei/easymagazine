                    ...
                    <div class="table">
                        ...
                        <table class="listing" cellpadding="0" cellspacing="0">
                            ...
                            foreach ($numbs as $num) {
                                ?>
                            <tr>
                                <td class="first style1"><?PHP echo $num->getTitle(); ?></td>
                                <td><a href="number.php?action=edit&id=<?PHP echo $num->getId(); ?>&list=<?PHP echo$lastList?>&pageSelected=<?PHP echo$pageSelected?>"><img src="../../resources/img/edit-icon.gif" width="16" height="16" alt="" /></a></td>
                                <td><a href="number.php?action=up&id=<?PHP echo $num->getId(); ?>&list=<?PHP echo$lastList?>&pageSelected=<?PHP echo$pageSelected?>"><img src="../../resources/img/up-arrow.png" width="16" height="16" alt="" /></a></td>
                                <td><a href="number.php?action=down&id=<?PHP echo $num->getId(); ?>&list=<?PHP echo$lastList?>&pageSelected=<?PHP echo$pageSelected?>"><img src="../../resources/img/down-arrow.png" width="16" height="16" alt="" /></a></td>
                                <td><a href="article.php?list=articlenumber&number_id=<?PHP echo $num->getId(); ?>"><img src="../../resources/img/article.png" width="16" height="16" alt="" /></a></td>
                                <td><a href="comment.php?list=commentnumber&number_id=<?PHP echo $num->getId(); ?>"><img src="../../resources/img/comments.png" width="16" height="16" alt="" /></a></td>
                                <td><a href="number.php?action=preview&id=<?PHP echo $num->getId(); ?>" target="_blank"><img src="../../resources/img/preview_icon.png" width="16" height="16" alt="Creates and publish ePub file" /></a></td>
                                <td><a href="number.php?action=epub&id=<?PHP echo $num->getId(); ?>&list=<?PHP echo$lastList?>&pageSelected=<?PHP echo$pageSelected?>"><img src="../../resources/img/epub.png" width="16" height="16" alt="Creates and publish ePub file" /></a></td>
                                <td>
                                        <?PHP if ($num->getPublished()) { ?>
                                    <img src="../../resources/img/tic.png" width="16" height="16" alt="save" />
                                        <?PHP } else { ?>
                                    <img src="../../resources/img/cross.png" width="16" height="16" alt="save" />
                                        <?PHP } ?>
                                </td>
                                <td class="last"><a href="number.php?action=requestdelete&id=<?PHP echo $num->getId(); ?>&list=<?PHP echo$lastList?>&pageSelected=<?PHP echo$pageSelected?>"><img src="../../resources/img/hr.gif" width="16" height="16" alt="add" /></a></td>
                            </tr>
                            <?
                            }
                            ?>
                        ...
                        <form name="form1" enctype="multipart/form-data" method="post" action="number.php?action=save&list=<?PHP echo$lastList?>&pageSelected=<?PHP echo$pageSelected?>">
                            <table class="listing form" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td class="last"><textarea name="MetaDescription" rows="4" cols="60"><?PHP echo $numb->getMetaDescription(); ?></textarea></td>
                                </tr>
                                <tr class="bg">
                                    <td class="first"><strong>Meta Keyword</strong></td>
                                    <td class="last"><textarea name="MetaKeyword" rows="4" cols="60"><?PHP echo $numb->getMetaKeyword(); ?></textarea></td>
                                </tr>
                                <tr>
                                    <td class="first"><strong><?php echo LANG_ADMIN_TABLE_PUBLISHED; ?></strong></td>
                                    <td class="last"><input type="checkbox" name="Published" value="1" <?PHP if($numb->getPublished()) echo 'checked="checked"'; ?>/></td>
                                </tr>
                                <tr class="bg">
                                    ...
                                    <td class="last"><input type="checkbox" name="commentsallowed" value="1"  <?PHP if($numb->getCommentsallowed()) echo 'checked="checked"'; ?>/></td>
                                </tr>
                                <tr class="bg">
                                    <td class="first"><strong><?php echo LANG_ADMIN_TABLE_CREATED; ?></strong></td>
                                    <td class="last"><?PHP echo $numb->getCreated(); ?></td>
                                </tr>
                                <tr>
                                    <td class="first"><strong><?php echo LANG_ADMIN_TABLE_UPDATED; ?></strong></td>
                                    <td class="last"><?PHP echo $numb->getUpdated(); ?></td>
                                </tr>
                                <tr class="bg">
                                    <td class="first"><strong>&nbsp;</strong></td>
                                <input type="hidden" name="id" value="<?PHP echo $numb->getId(); ?>">
                                <input type="hidden" name="indexnumber" value="<?PHP echo $numb->getIndexnumber(); ?>">
                                <input type="hidden" name="created" value="<?PHP echo $numb->getCreated(); ?>">
                                <input type="hidden" name="updated" value="<?PHP echo $numb->getUpdated(); ?>">
